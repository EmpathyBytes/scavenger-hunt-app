	...
	return (
		<SafeAreaView style={styles.screen} edges={['left', 'right']}>
			<View style={styles.container}>
				<BackButton style={styles.backbutton}backgroundColor={COLORS.beige} onPress={()=>navigation.goBack()} />
			...
			>
				<View style={styles.modalOverlay}>
					<View style={styles.modalContent}>
						...
						>
							<Entypo name="chevron-down" size={30} color={COLORS.navy} />
						</TouchableOpacity>
						
						<BasicButton
                            style={styles.joinSessionButton}
							text="Join New Session"
